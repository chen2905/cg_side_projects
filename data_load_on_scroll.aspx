<%@ Page Language="C#" AutoEventWireup="true" CodeFile="data_load_on_scroll.aspx.cs" Inherits="_data_load_on_scroll" %>
...
<body>
    ...
    <script src="js/hotel_service.js?date=<%=dateTime%>"></script>
